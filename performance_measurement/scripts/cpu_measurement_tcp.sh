...
./cpu_usage_tcp.sh 25 transfer_test_100M.htm ../performance_measurement/cpu_usage/100MB_TCP/
./cpu_usage_tcp.sh 25 transfer_test_1G.htm ../performance_measurement/cpu_usage/1GB_TCP/
./cpu_usage_tcp.sh 25 transfer_test_5G.htm ../performance_measurement/cpu_usage/5GB_TCP/

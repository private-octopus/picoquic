...
do
    ...
    monitor_cpu_usage "iperf_server" "${output_folder}server_usage_${i}.csv" $SERVER_PID & 
    MONITOR_SERVER_PID=$!
    ...
    # Start the client
    iperf -c 127.0.0.1 -t 15 &
    CLIENT_PID=$!
    echo "Client started with PID: $CLIENT_PID"


    # # Start monitoring client CPU usage
    monitor_cpu_usage "iperf_client" "${output_folder}client_usage_${i}.csv" $CLIENT_PID & 
    MONITOR_CLIENT_PID=$!
